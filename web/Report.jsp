...
<%List<Product> saleList = (List<Product>) session.getAttribute("saleList"); %>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <ul>
                ...
                <li>
                    <form action="ProcessSales" method="POST">
                        ...
                        <input type="submit" name="submit" value="Sale_Record" style="background-color:black;color: white"/>
                    </form>
                </li>
                <li>
    ...
    <div class="content read" style="position:relative;left:140px;top:70px;">
        ...
        <form action="ProcessReport" method="POST">
            ...
            <Button type="submit"  name="submit" value="leastFive">Least Five </button>
            <Button type="submit"  name="submit"  value="topFive" >Top Five</button>

        </form>

        <h2 style="background-color: grey;color: white;text-align: center">Sale Report</h2>
        ...
        <table>
            ...
            <tbody>
                ...
                <%  int[] memberArr = new int[saleList.size()];
                    for (int i = 0; i < saleList.size(); ++i) {
                        Product sale = saleList.get(i);%>
                <tr>
                    <td align="center"><%=sale.getProductID()%></td>
                    <td align="center"><%=sale.getProductName()%></td>
                    <td align="center"><%=sale.getTotal()%></td>
