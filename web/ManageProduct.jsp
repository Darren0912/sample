...
<html>
    ...
    <div class="content read" style="position:relative;left:140px;top:70px;">
        ...
        <h2 style="background-color: grey;color: white;text-align: center">Product Information</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                ...
                %>
                <tr>
                    <td align="center"><img src="data:image/jpg;base64,<%= productList.get(i).getByte64Image()%>" class="card-img" width="30" height="100" ></td>
                    <td align="center"><%=productList.get(i).getProductID()%></td>
                    <td align="center"><%=productList.get(i).getStaffID()%></td>
                    <td align="center"><%=productList.get(i).getProductName()%></td>
                    <td align="center"><%=productList.get(i).getDescription()%></td>
                    <td align="center"><%=productList.get(i).getPrice()%></td>
                    <td align="center"><%=productList.get(i).getCategory()%></td>
