<%-- 
    ...
    Created on : May 7, 2023, 1:07:17 AM
    Author     : User
--%>
...
<%List<BeastOrder> orderList1 = (List<BeastOrder>) session.getAttribute("orderList1"); %>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="content read" style="position:relative;left:140px;top:70px;">
        ...
        <h2 style="background-color: grey;color: white;text-align: center">Order Information</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <%  int[] orderArr = new int[orderList1.size()];
                    for (int i = 0; i < orderList1.size(); ++i) {
                        BeastOrder order = orderList1.get(i);
                %>
                <tr>
                    
            <form action="ProcessOrder" method="POST">
                <td align="center"><input type="text" name="id" value="<%=order.getOrderID()%>" readonly /></td>
                <td align="center"><input type="text" name="cart" value="<%=order.getShoppingCartID()%>" readonly /></td>
                <td align="center">
                    <select name="status">
                        <option value="<%= order.getOrderStatus()%>"><%= order.getOrderStatus()%></option>
                ...
                <td align="center"><input type="text" name="fee" value="<%=order.getDeliveryFee()%>" readonly /></td>
