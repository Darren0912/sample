...
<html>
    ...
    <div class="content read" style="position:relative;left:140px;top:70px;">
        ...
        <h2 style="background-color: grey;color: white;text-align: center">Staff Information</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <%  int[] staffArr = new int[staffList.size()];
                    for (int i = 0; i < staffList.size(); ++i) {
                        Staff emp = staffList.get(i);
                %>
                <tr>
                    <td align="center"><%=emp.getStaffID()%></td>
                    <td align="center"><%=emp.getStaffName()%></td>
                    <td align="center"><%=emp.getPosition()%></td>
                    <td align="center"><%=emp.getPhoneNo()%></td>
                    <td align="center"><%=emp.getPassword()%></td>
                    <td align="center">

                        <form action="ProcessStaff" method="POST">
                            <input type="hidden" name="staffID" value="<%=emp.getStaffID()%>" />
        ...
        <form action="ProcessStaff" method="POST">
            <p>
                <input type="submit" name="submit" value="CreateStaff">
            </p>
        </form>
    </div>
</html>
