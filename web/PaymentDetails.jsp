...
<html>
    ...
    <%@include file="include/newheader2.jsp" %>
        ...
        <form action="PaymentDetails" method="POST">
            <input type="hidden" value="<%=order.getOrderID()%>" name="order" />
            <c:if test="${not empty typePayment}">
               <input type="hidden" value="${typePayment}" name="typePayment"/>
            </c:if>
                    ...
                    <div class="row gx-3">
                        <div class="col-12">
                            <div class="d-flex flex-column">
                                ...
                                <input class="form-control mb-3" type="text" name="memberName" placeholder="...">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex flex-column">
                                <p class="text mb-1">E-mail</p>
                                <input class="form-control mb-3" type="text" name="email" placeholder="...">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex flex-column">
                                ...
                                <input class="form-control mb-3" type="text" name="phonenum" placeholder="...">
                            </div>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="d-flex flex-column">
                                ...
                                <input class="form-control mb-3" type="text" name="address" placeholder="...">
                            </div>
                        </div>

                        <div class="col-6">
                            <div class="d-flex flex-column">
                                <p class="text mb-1">Home or Workplace</p>
                                <input class="form-control mb-3 pt-2 " type="text" name="place" placeholder="...">
                            </div>
                        </div>  
                        <div class="col-12">                     
                            <button type="submit" class="custom-btn btn-4"><span>Submit</span></button>
                        </div>
                    </div>
                </div>
            </div>
