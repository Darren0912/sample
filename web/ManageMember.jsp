...
<html>
    ...
    <div class="content read" style="position:relative;left:140px;top:70px;">
        ...
        <h2 style="background-color: grey;color: white;text-align: center">Member Information</h2>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <%  int[] memberArr = new int[memberList.size()];
                    for (int i = 0; i < memberList.size(); ++i) {
                        Member member = memberList.get(i);%>
                <tr>
                    <td align="center"><%=member.getMemberID()%></td>
                    <td align="center"><%=member.getUsername()%></td>
                    <td align="center"><%=member.getEmail()%></td>
                    <td align="center"><%=member.getPassword()%></td>
